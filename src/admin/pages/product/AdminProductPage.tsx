  ...
  return (
    <>
      <div className="ml-5 flex justify-between items-center">
        ...
        <div className="mt-6 flex justify-end mb-10 gap-4">
              ...
              <div className="space-y-4">
                <div className="flex flex-wrap gap-2">
                  {product.sizes.map((size) => (
                    <span
                      key={size}
                      className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-black text-white border border-blue-200"
                    >
                      {size}
                      <button
